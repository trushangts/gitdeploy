 ...
 *
 */
define('IP_ALLOW', serialize(array('localhost')));
 ...
 *
 */
define('REMOTE_REPOSITORY', 'gitdeploy');
 ...
 */
define('BRANCH', serialize(array('master')));
 ...
 */
define('ACCESS_TOKEN', 'qqwweerrttyyuuiioopp');
...
define('TARGET_DIR', '/opt/lampp/htdocs/gitdeploy');

/* LOG_FILE: Full path of log file. Leave blank to disable logging */
define('LOG_FILE', '/opt/lampp/htdocs/gitdeploy/deploy.log');
